<footer class="primary-footer" id="footer">
  <div class="content-wrapper">
    <div class="social">
      <a class="external-link-icon facebook" href="https://www.facebook.com/ShiftCodesTK" rel="external noopener" target="_blank" title="ShiftCodesTK on Facebook" aria-label="ShiftCodesTK on Facebook"><span class="external fas fa-external-link-square-alt"></span><span class="icon fab fa-facebook-square"></span></a>
      <a class="external-link-icon twitter" href="https://twitter.com/ShiftCodesTK" rel="external noopener" target="_blank" title="ShiftCodesTK on Twitter" aria-label="ShiftCodesTK on Twitter"><span class="external fas fa-external-link-square-alt"></span><span class="icon fab fa-twitter-square"></span></a>
