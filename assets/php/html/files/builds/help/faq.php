...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="https://shiftcodestk.com/assets/img/metadata/help/faq.png">
    <meta property="twitter:image" content="https://shiftcodestk.com/assets/img/metadata/help/faq.png">
    ...
    <main class="content-wrapper">
      ...
      <section class="faq-group">
        ...
        <div class="dropdown-panel">
          ...
          <div class="body content-container">
            <p>Yes, most SHiFT Codes will be issued with an Expiration Date, typically about two to three weeks after their release. However, some SHiFT Codes have and can be issued without an Expiration Date.</p>
          </div>
        </div>
        <div class="dropdown-panel">
          <button class="header">
