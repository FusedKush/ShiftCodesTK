  ...
  <div class="content-wrapper">
    <div class="section counters">
      <div class="badge total inactive" id="shift_header_count_total" title="No SHiFT Codes Available" aria-label="No SHiFT Codes Available">
        <span class="count">0</span><span class="fas fa-key"></span>
      </div>
      <div class="badge new inactive" id="shift_header_count_new" title="No New SHiFT Codes" aria-label="No New SHiFT Codes">
        <span class="count">0</span><span class="fas fa-star"></span>
      </div>
      <div class="badge exp inactive" id="shift_header_count_exp" title="No Expiring SHiFT Codes" aria-label="No Expiring SHiFT Codes">
        <span class="count">0</span><span class="fas fa-exclamation-triangle"></span>
      </div>
    </div>
    <div class="section sort">
      <button id="shift_header_sort" title="Sorted by Newest Codes First. Click to change sort." aria-label="Sorted by Newest Codes First. Click to change sort." disabled aria-disabled><span class="fas fa-sort-amount-down"></span></button>
    </div>
  </div>
</header>
<div class="overlay" id="shift_overlay">
  <?php include("./assets/php/imports/spinner.php"); ?>
  ...
  <div class="panel" role="button" data-expanded="false" aria-expanded="false" tabindex="0">
    ...
    <div class="body">
      ...
      <div class="section src">
        ...
        <div class="content"><a target="_blank" rel="external noopener" tabindex="-1"><span class="fas fa-external-link-square-alt"></span><span class="text"></span></a></div>
      </div>
