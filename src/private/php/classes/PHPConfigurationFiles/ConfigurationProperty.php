<?php
  ...
  class ConfigurationProperty {
     ...
     * 
     * @param int|null $timestamp If provided, this is a *Unix Timestamp* generated by {@see Timestamps\time()}. If omitted, the *Current Timestamp* will be used. 
    ...
    public function updateTimestamp (string $timestamp = null): bool {
      ...
      if (isset($timestamp)) {
        ...
        $this->lastModified = Timestamps\time();
      }
