<?php
  ...
  interface StaticConfigurationValuesInterface {
    public static function listConfigurationValues (
      bool $flush_index = false
      ): array;

    public static function configurationValueExists (
      string $property
      ): bool;
    ...
    public static function addConfigurationValue (
      string $property_name, 
      $property_value, 
      string $secret_key = null
      ): bool;

    public static function removeConfigurationValue (
      string $property_name
    ): bool;
