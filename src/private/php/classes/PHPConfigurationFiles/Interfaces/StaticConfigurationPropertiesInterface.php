<?php
  ...
  interface StaticConfigurationPropertiesInterface extends ConstantsInterface {
    public static function getConfigurationProperties (
    ): array;

    public static function changeConfigurationProperties (
      array $properties
    ): bool;
    ...
    public static function changeConfigurationContents (
      $contents = null
    ): bool;

    public static function getConfigurationValueProperties (
