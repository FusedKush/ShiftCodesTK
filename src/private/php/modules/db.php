<?php
  ...
  class ShiftCodesTKDatabase_Old {
     ...
     */
    public function __construct () {
      $this->con = new mysqli(...array_values(\ShiftCodesTK\Secrets::getSecret('db')));
      $this->con->select_db(\ShiftCodesTK\BUILD_INFORMATION['branch']['is_prod_branch'] ? "ShiftCodesTK" : "ShiftCodesTK_beta");
