...
<?php (function () { ?>
  <?php
    $shift_properties = [];
    $page_configuration = \ShiftCodesTK\PageConfiguration::getCurrentPageConfiguration();
    $shift_properties['shift_configuration'] = $page_configuration->getShiftConfiguration()
      ->getProperties();
    $shift_properties['badges'] = (function () {
      $badges = [
        ['name' => 'total',    'icon' => 'key'],
        ['name' => 'new',      'icon' => 'star'],
      ...
      foreach ($badges as &$badge) {
        $badge['cap'] = Strings\transform($badge['name'], Strings\TRANSFORM_CAPITALIZE_FIRST);
      }

      return $badges;
    })();

    $shift_properties = (new Strings\StringArrayObj($shift_properties))
      ->encodeHTML()
      ->getArray();
  ?>
    ...
    <div class="primary">
      <div class="content-wrapper">
        <div class="section badges">
          <?php foreach($shift_properties['badges'] as &$badge) : ?>
            <?php
              $count = 0 ;
        ...
        <div class="section buttons">
          <?php if (CurrentUser::is_logged_in()) : ?>
            <?php
              $game_id = $shift_properties['shift_configuration']['game'];
    ...
    <div class="slideout" hidden>
      <div class="content-wrapper">
        <?php
          ...
          $code_owner = $shift_properties['shift_configuration']['owner'];

          getForm_shiftSortFilter(
            $shift_properties['shift_configuration']['game'], 
            (isset($code_owner) 
              && $code_owner !== false 
  ...
  <main class="feed content-wrapper">
    ...
    <div 
      ...
      id="shift_code_list" 
      <?= " data-shift=" . json_encode($shift_properties['shift_configuration']); ?>
      >
    </div>
    <div 
      class="pager" 
