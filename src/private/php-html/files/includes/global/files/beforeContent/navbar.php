      ...
      <div class="right">
        <li role="menuitem">
          ...
          aria-pressed="false">
            <span class="bubble bubble-dynamic"></span>
            <?php
              $profile_picture = CurrentUser::is_logged_in()
                ? CurrentUser::get_current_user(true)->profile_picture
                : null;
            ?>
            <?php if (isset($profile_picture)) : ?>
              <img 
                alt="FusedKush's Profile Picture" 
                src="/assets/img/users/profiles/149357043452/e266e1c897bb.jpg?_request_token=<?= $_SESSION['token']; ?>&size=128">
            <?php else : ?>
