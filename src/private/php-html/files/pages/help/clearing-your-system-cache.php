<?php
  ...
  (new PageConfiguration('help/clearing-your-system-cache'))
    ->setTitle('Clearing your System Cache')
    ->setGeneralInfo(
      'How to clear your system cache on PC, Xbox, or Playstation',
      'tps/3'
    )
    ->saveConfiguration();
?>
...
<html lang="en">
  <head>
    ...
    <!-- Local Styles -->
    <link href="/assets/css/local/help/clearing-your-system-cache.css<?php echo \ShiftCodesTK\VERSION_QUERY_STR; ?>" rel="stylesheet"></link>
    <!--// Markup \\-->
