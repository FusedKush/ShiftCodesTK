(function () {
  /** 
   * The `forms` namespace is responsible for the management of Forms and their associated data. 
  ...
  let interval = setInterval(function () {
    if (typeof globalFunctionsReady != 'undefined') {
      ...
      ShiftCodesTK.forms = {
        // Properties
        /** 
         * @var {boolean} ShiftCodesTK.forms.isLoaded Indicates if the `forms` module has been completely loaded. 
         **/
        isLoaded: false,
