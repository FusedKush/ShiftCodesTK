    ...
    if (isReady) {
      ...
      ShiftCodesTK.profile_card = {
        ...
        card_data_template: {
          ...
          permissions: {
            /**
             * @property Indicates if the current user can *report* the user of the profile card. 
             * @type {boolean=} Defaults to **false**.
             */
            can_report: false,
            /**
             * @property Indicates if the current user can perform an *enforcement action* against the user of the profile card. 
             * @type {boolean=} Defaults to **false**.
             */
            can_enforce: false,
            /**
             * @property Indicates if the current user can *edit* the profile card. 
             * @type {boolean=} Defaults to **false**.
             */
            can_edit: false,
            /**
             * @property Indicates if the current user can *change their username* using the profile card. 
             * @type {boolean=} Defaults to **false**.
             */
