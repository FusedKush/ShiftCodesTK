<?php
  ...
  namespace ShiftCodesTK\Validations {
    ...
    /** Constants */
    /** 
     * @var array A list of *Variable Types* and their associated *Aliases*, in the following format:
     * > `string` _Type Name_ => `array` _Type Aliases_
     **/
  ...
  define('VALIDATION_MESSAGES', [
    'typeMismatch' => array_merge(
      [
        ...
        'hash'     => '${param} cannot be a valid hash.',
        'date'     => '${param} cannot be a valid date.',
        'url'      => '${param} cannot be a valid URL.'
      ],
        array_fill_keys([ 'integer', 'float' ], '${param} cannot be a valid number.'),
    ),
