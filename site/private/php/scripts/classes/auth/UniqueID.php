<?php
  ...
  class UniqueID {
    /** @var array Represents the *ID Bit Structure* of the Unique ID as an `array` in the following format:
    ...
    /** @var array Represents the *ID Bit Retrieval Comparisons* of the Unique ID Pieces as an `array` in the following format:
    ...
    /** @var array Represents the data used to manage the generation of the Unique IDs:
     * 
     * | Data | Description |
     * | --- | --- |
    ...
    /** @var Integers\BitwiseInt The *Unique ID* as a `BitwiseInt` object. */
    public $unique_id = null;
    /** @var array The *Unique ID*, parsed as an `array` of pieces. */
    public $parsed_id = [
      'timestamp'      => null,
      'worker_id'      => null,
      'process_id'     => null,
