...
<html lang="en">
  <head>
    ...
    <!-- Local Styles -->
    <link href="assets/css/local/index.css<?php echo $svQueryString; ?>" rel="stylesheet"></link>
  ...
  <body data-theme="main">
    ...
    <!-- Local Scripts -->
    <script async src="/assets/js/local/index.js<?php echo $svQueryString; ?>"></script>
  </body>
</html>
